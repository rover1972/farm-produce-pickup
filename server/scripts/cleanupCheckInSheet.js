...
async function cleanupCheckInSheet() {
  try {
    ...
    // Define the new headers we want to keep
    const newHeaders = ['id', 'identifier', 'address', 'addressId', 'notes', 'checkInTime', 'checkOutTime', 'status'];
